...
var encryptReg = new RegExp("\\+","g");
var decryptReg = new RegExp("@","g");
/**
*  dev:dxb
*  date:2019/2/20
*  decription:加密函数，str为明文，返回密文，btoa是将binary transfer to ascll
*/
...
*  dev:dxb
*  date:2019/2/20
*  decription:解密函数，str为密文，结果返回明文
*/
function decrypt(str){
	//"result" : "V6MDQv78HVnO4oQ11exhz8i21MItjJjf5z6DmaB1/JKYYCz0Twnw/A=="  ׵ܘޡڻ
	//{"result":"1008","msg":"Ĝëխϳ"}
